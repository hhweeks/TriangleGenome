...
public class GenomeTable extends JPanel
{
    ...
    public GenomeTable(Genome g) {
        ...
        for(int i = 0; i < 200; i++)
        {
          objectArr.add(new Object[]{
              i + 1,
              g.geneList.get(i).xpoints[0],
              g.geneList.get(i).ypoints[0],
              g.geneList.get(i).xpoints[1],
              g.geneList.get(i).ypoints[1],
              g.geneList.get(i).xpoints[2],
              g.geneList.get(i).ypoints[2],
              g.geneList.get(i).r,
              g.geneList.get(i).g,
              g.geneList.get(i).b,
              g.geneList.get(i).a
