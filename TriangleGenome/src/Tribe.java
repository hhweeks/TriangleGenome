...
public class Tribe extends Thread {
	...
	/****************************************************************************
	 * Constructor Input:BufferedImage of master image, GUI object that is
	 * parent of this tribe thread Description: Creates a new object to hold
	 * Genome in its Genome list.
	 ****************************************************************************/
	...
	/****************************************************************************
	 * interCrossRoutine Input:integer sigma, half the size of the Tribe's
	 * genome list. Output:none Description: begins inter-tribe crossover.
	 * Randomly selects, while favoring fit genomes, 2 genomes to cross over,
	 * then does single point cross over on them 6 times.
	 ****************************************************************************/
	 ...
	 * TriangleGenomeGUI's crossTribes method. It returns deep copies of 2
	 * random Genomes (favoring selection of fit ones) for the cross over
	 ****************************************************************************/
