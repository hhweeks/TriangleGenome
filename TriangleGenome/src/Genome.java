 ...
 *         the picture that it is "representing", as well as a fitscore, rating
 *         how will it recreates the original image (updated by statistics)
 ****************************************************************************/
public class Genome implements Comparable<Genome>
{
  ...
  /****************************************************************************
   * Constructor given diemnsion Input:dimensions of the picture being recreated
   ...
   * compareTo
   * Input:Genome
   * Output:int representing which Genome has better fitness score
   * Description:compares 2 genomes, returns negative if passed genome is more fit
   ****************************************************************************/
