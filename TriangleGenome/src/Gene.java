 ...
 *
 * @author Hans Weeks
 * @author Paige Romero This object holds 10 peices of data, representing the
 *         expression of a triangle: x and y coordinates for three points, r,g,b
 *         color values and opacity value a. Building block for the genome
 *         class.
 ****************************************************************************/
public class Gene extends Polygon {
	...
	/****************************************************************************
	 * Constructor Input: coordinates x and y for three points in array, and 4
	 * ints r,g,b,a 0<X<255 Description:creates a gene with desired genes
	 ****************************************************************************/
	...
	/****************************************************************************
	 * setPoints Input:array of points Output:none Description:set method for x
	 * and y vertices of triangle
	 ****************************************************************************/
	...
	public String toString() {
		...
		return xpoints[0] + "," + ypoints[0] + ";" + xpoints[1] + ","
				+ ypoints[1] + ";" + xpoints[2] + "," + ypoints[2] + ";" + r
				+ "," + g + "," + b + "," + a;
