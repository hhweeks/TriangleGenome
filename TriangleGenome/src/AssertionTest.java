public class AssertionTest {
	...
	public static void main(String[] args) {
		...
		// randomize the first two genomes and make a copy with different a
		// different
		...
		System.out.println("Hamming score for two random genomes:  "
				+ GenomeUtilities.hammingDistance(oneGenome, twoGenome));
		System.out
				.println("Hamming score for two identical genomes with diffent addresses:  "
						+ GenomeUtilities.hammingDistance(oneGenome,
								copyOfGenomeOne));
		System.out
				.println("Hamming score for a parent and child after a cross over:  "
						+ GenomeUtilities.hammingDistance(oneGenome,
								threeGenome));
		System.out
				.println("Hamming score for a parent and the other child after a cross over:  "
						+ GenomeUtilities
								.hammingDistance(oneGenome, fourGenome));
	...
	Genome sonGenome, Genome daughterGenome, int crossPoint) {
		...
		CrossOver.breed(papaGenome, mamaGenome, sonGenome, daughterGenome,
				crossPoint);
		...
		long startDiff = GenomeUtilities
				.hammingDistance(papaGenome, mamaGenome);
		long oneChildDiff = GenomeUtilities.hammingDistance(papaGenome,
				sonGenome);
		long twoChildDiff = GenomeUtilities.hammingDistance(papaGenome,
				daughterGenome);
